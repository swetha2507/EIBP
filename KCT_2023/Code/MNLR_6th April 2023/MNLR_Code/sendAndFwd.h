...
#define MESSAGE_TYPE_REQUEST_IP_RESOLVE_BR 17
#define MESSAGE_TYPE_RESPONSE_IP_RESOLVE_BR 18
...
#define MESSAGE_TYPE_ENDNW_INTER_IP  5
#define MESSAGE_TYPE_QUERY  3
#define MESSAGE_TYPE_QUERY_REQUEST  0
#define MESSAGE_TYPE_QUERY_RESPONSE  1
#define MESSAGE_TYPE_INTERAS_IP  3
