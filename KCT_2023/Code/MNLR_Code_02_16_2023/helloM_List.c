...
void encaps_ip_msg(char[2048], unsigned char*, char[5], struct sockaddr_ll);
...
void msg_typ_ip_res(char[2048], unsigned char*, char[5], struct sockaddr_ll);
...
void msg_typ_ip_add(char[2048], unsigned char*, char[5], struct sockaddr_ll);
				...
				*/
				...
				if (strcmp(recvOnEtherPort, "eth0") != 0) {
					...
					case MESSAGE_TYPE_DATA:
						encaps_ip_msg(buffer, ethhead, recvOnEtherPort, src_addr);
						break;
					...
					case MESSAGE_TYPE_RESPONSE_IP_RESOLVE:
						msg_typ_ip_res(buffer, ethhead, recvOnEtherPort, src_addr);
						break;
					...
					case MESSAGE_TYPE_PUBLISH_IP_ADD:
						msg_typ_ip_add(buffer, ethhead, recvOnEtherPort, src_addr);
						break;
...
void encaps_ip_msg(char buffer[2048], unsigned char* ethhead, char recvOnEtherPort[5], struct sockaddr_ll src_addr) {
	printf("\n");
	MPLRDataReceivedCount++;
	MPLROtherReceivedCount--;
...
void msg_typ_ip_res(char buffer[2048], unsigned char* ethhead, char recvOnEtherPort[5], struct sockaddr_ll src_addr) {
...
void msg_typ_ip_add(char buffer[2048], unsigned char* ethhead, char recvOnEtherPort[5], struct sockaddr_ll src_addr) {
