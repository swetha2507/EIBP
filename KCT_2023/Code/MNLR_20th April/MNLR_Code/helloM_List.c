	...
	void hello_msg(char[2048], unsigned char*, char[5], struct sockaddr_ll, int*);
	void encaps_ip_msg(char[2048], unsigned char*, char[5], struct sockaddr_ll, int*);
	void ip_tier_mapping_msg(char[2048], unsigned char*, char[5], struct sockaddr_ll, int*);
	void msg_typ_join(char[2048], unsigned char*, char[5], struct sockaddr_ll, int*);
	void msg_typ_labl_available(char[2048], unsigned char*, char[5], struct sockaddr_ll, int*);
	void msg_typ_labl_accptd(char[2048], unsigned char*, char[5], struct sockaddr_ll, int*);
	void msg_typ_labl_add(char[2048], unsigned char*, char[5], struct sockaddr_ll, int*);
	void msg_typ_labl_delt(char[2048], unsigned char*, char[5], struct sockaddr_ll, int*);
	void msg_typ_rqst_ip(char[2048], unsigned char*, char[5], struct sockaddr_ll, int*);
	void msg_typ_ip_res(char[2048], unsigned char*, char[5], struct sockaddr_ll, int*);
	void msg_typ_ip_req_br(char[2048], unsigned char*, char[5], struct sockaddr_ll, int*);
	void msg_typ_ip_resp_br(char[2048], unsigned char*, char[5], struct sockaddr_ll, int*);
	void msg_typ_labl_lst(char[2048], unsigned char*, char[5], struct sockaddr_ll, int*);
	void msg_typ_ip_delt(char[2048], unsigned char*, char[5], struct sockaddr_ll, int*);
	void msg_typ_ip_add(char[2048], unsigned char*, char[5], struct sockaddr_ll, int*);

	bool churn_flag = false;
	int down_flag = 0;
	double conv_time;
					...
					*/
					...
					if (strcmp(recvOnEtherPort, "eth0") != 0) {
						...
						case MESSAGE_TYPE_CTRL:
							hello_msg(buffer, ethhead, recvOnEtherPort, src_addr, &n);
							break;
						...
						case MESSAGE_TYPE_ENDNW:
							ip_tier_mapping_msg(buffer, ethhead, recvOnEtherPort, src_addr, &n);
							break;

						case MESSAGE_TYPE_JOIN:
							msg_typ_join(buffer, ethhead, recvOnEtherPort, src_addr, &n);
							break;

						case MESSAGE_TYPE_LABELS_AVAILABLE:
							msg_typ_labl_available(buffer, ethhead, recvOnEtherPort, src_addr, &n);
							break;

						case MESSAGE_TYPE_LABELS_ACCEPTED:
							msg_typ_labl_accptd(buffer, ethhead, recvOnEtherPort, src_addr, &n);
							break;

						case MESSAGE_TYPE_MY_LABELS_ADD:
							msg_typ_labl_add(buffer, ethhead, recvOnEtherPort, src_addr, &n);
							break;

						case MESSAGE_TYPE_MY_LABELS_DELETE:
							msg_typ_labl_delt(buffer, ethhead, recvOnEtherPort, src_addr, &n);
							break;

						case MESSAGE_TYPE_REQUEST_IP_RESOLVE:
							msg_typ_rqst_ip(buffer, ethhead, recvOnEtherPort, src_addr, &n);
							break;
						...
						case MESSAGE_TYPE_REQUEST_IP_RESOLVE_BR:
							msg_typ_ip_req_br(buffer, ethhead, recvOnEtherPort, src_addr, &n);
							break;

						case MESSAGE_TYPE_RESPONSE_IP_RESOLVE_BR:
							msg_typ_ip_resp_br(buffer, ethhead, recvOnEtherPort, src_addr, &n);
							break;

						case MESSAGE_TYPE_LABELS_LOST:
							msg_typ_labl_lst(buffer, ethhead, recvOnEtherPort, src_addr, &n);
							break;

						case MESSAGE_TYPE_PUBLISH_IP_DELETE:
							msg_typ_ip_delt(buffer, ethhead, recvOnEtherPort, src_addr, &n);
							break;
						...
						if (checkMSGType != MESSAGE_TYPE_CTRL && checkMSGType != MESSAGE_TYPE_DATA && checkMSGType != MESSAGE_TYPE_REQUEST_IP_RESOLVE &&
							checkMSGType != MESSAGE_TYPE_LABELS_ACCEPTED && checkMSGType != MESSAGE_TYPE_REQUEST_IP_RESOLVE_BR) {
	...
	int main(int argc, char** argv) {
		...
		*/
		...
		if (argc > 1) { //only if the number of arguments is greater than 1, we will go forward. Otherwise exit code execution
			...
			if (argc > 0) {
				opt = argv[0];
				// Checking whether the node is a border router connected to another AS or not
				if (strcmp(opt, "-AS") == 0) {
					argc--;
					argv++;
					char* port = argv[0];
	...
	*/
	...
	void hello_msg(char buffer[2048], unsigned char* ethhead, char recvOnEtherPort[5], struct sockaddr_ll src_addr, int* n) {
	...
	void ip_tier_mapping_msg(char buffer[2048], unsigned char* ethhead, char recvOnEtherPort[5], struct sockaddr_ll src_addr, int* n) {
	...
	void msg_typ_join(char buffer[2048], unsigned char* ethhead, char recvOnEtherPort[5], struct sockaddr_ll src_addr, int* n) {
	...
	void msg_typ_labl_available(char buffer[2048], unsigned char* ethhead, char recvOnEtherPort[5], struct sockaddr_ll src_addr, int* n) {
	...
	void msg_typ_labl_accptd(char buffer[2048], unsigned char* ethhead, char recvOnEtherPort[5], struct sockaddr_ll src_addr, int* n) {
		int stablePort = 0;
		stablePort = staging(recvOnEtherPort);
	...
	void msg_typ_labl_add(char buffer[2048], unsigned char* ethhead, char recvOnEtherPort[5], struct sockaddr_ll src_addr, int* n) {
	...
	void msg_typ_labl_delt(char buffer[2048], unsigned char* ethhead, char recvOnEtherPort[5], struct sockaddr_ll src_addr, int* n) {
	...
	void msg_typ_rqst_ip(char buffer[2048], unsigned char* ethhead, char recvOnEtherPort[5], struct sockaddr_ll src_addr, int* n) {
	...
	void msg_typ_ip_req_br(char buffer[2048], unsigned char* ethhead, char recvOnEtherPort[5], struct sockaddr_ll src_addr, int* n) {
		uint8_t totalEntries = 0;
	...
	void msg_typ_ip_resp_br(char buffer[2048], unsigned char* ethhead, char recvOnEtherPort[5], struct sockaddr_ll src_addr, int* n) {
	...
	void msg_typ_labl_lst(char buffer[2048], unsigned char* ethhead, char recvOnEtherPort[5], struct sockaddr_ll src_addr, int* n) {
	...
	void msg_typ_ip_delt(char buffer[2048], unsigned char* ethhead, char recvOnEtherPort[5], struct sockaddr_ll src_addr, int* n) {
